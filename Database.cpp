...
void __fastcall TDBForm::ButtonSortKlikClick(TObject *Sender)
{
			DataModule1->TOdjel->IndexFieldNames = "brojZaposlenika DESC";
}
//---------------------------------------------------------------------------

void __fastcall TDBForm::Button7Click(TObject *Sender)
{
